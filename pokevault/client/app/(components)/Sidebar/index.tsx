    ...
    return (
        <div className={sidebarClassNames}>
            ...
            >
                ...
                <button
                    className="md:hidden px-3 py-3 bg-gray-100 rounded-full hover:bg-pink-200"
            ...
            <div className={`${isSideBarCollapsed  ? "hidden" : "block"} md-10`}>
                <p className='text-center text-xs text-blue-500'> {/* change className on p to change color or footer text. */}
